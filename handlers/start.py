...
WELCOME_TEXT = (
    ...
    "презентаций, видео и инфографики через OpenRouter.\n\n"
...
HELP_TEXT = (
    ...
    "«🧾 Исходный текст / OCR», а кнопка «📄 Исходник .txt» "
    "отдаёт весь OCR одним файлом.\n\n"
    ...
    "Текстовые и визуальные задачи выполняются через OpenRouter.\n\n"
    "*Команды:*\n"
    "/start — начало работы\n"
    "/help — эта справка"
)
